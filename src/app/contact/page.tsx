				...
				<div className="text-center mb-12">
					...
					{submitStatus !== "success" && (
						<p className="text-lg text-primary-800 max-w-2xl mx-auto">
							Van kérdésed az esküvővel kapcsolatban? Írj nekünk, és igyekszünk
							mielőbb válaszolni!
						</p>
					)}
				</div>
						...
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							{submitStatus === "error" && (
								<div className="mt-4 p-4 bg-red-100 border border-red-300 rounded-lg text-red-800">
									Hiba történt az üzenet küldése során. Kérjük, próbáld újra
									később.
								</div>
							)}
						</form>
					...
					<div className="mt-12 text-center">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
							<div className="p-6 bg-primary-100 rounded-xl border border-primary-200">
								<h3
									className={`${cormorant.className} text-2xl text-primary-900 mb-2`}>
									Enikő
								</h3>
