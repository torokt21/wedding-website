				...
				<div className="text-center mb-12">
					...
					{submitStatus !== "success" && (
						<p className="text-lg text-primary-800 max-w-2xl mx-auto">
							...
							esküvőnkön! Minden információ segít nekünk a tökéletes nap
							megszervezésében.
						</p>
					)}
				</div>
				...
				{submitStatus === "success" && (
					<div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-primary-200">
						<div className="text-center">
							...
							<h2 className={`${cormorant.className} text-3xl text-primary-900 mb-4`}>
							...
							{formData.canAttend !== "nem" && (
								<div>
									...
									<p className="text-sm text-primary-600 mt-2">
										💡 <strong>Fontos:</strong> Ha tömegközlekedéssel érkezel,
										akkor valaki a buszmegállótól autóval elvisz a helyszínre.
										További információkat majd e-mailben küldünk.
									</p>
								</div>
							)}
					...
					<div className="mt-12 text-center">
						<div className="p-6 bg-primary-100 rounded-xl border border-primary-200">
							...
							<p className="text-primary-800 mb-2">
								Kérjük, hogy a visszajelzést <strong>minél hamarabb</strong> küldd
								el, de legkésőbb <strong>30 nappal az esküvő előtt</strong>!
							</p>
